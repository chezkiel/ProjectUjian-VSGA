...
<body>
    ...
    <header class="py-3 navigation text-bg-dark">
        <div class="container d-flex flex-wrap justify-content-center">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="kontak.php" class="nav-link link-body-emphasis px-2 active" aria-current="page">Kontak Kami</a></li>
    ...
    <div class="content">
        ...
        <div class="px-4 py-5 my-5 text-center">
            <h1 class="display-5 fw-bold text-body-emphasis">Our Contact</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Thank you for visiting the official website of Akuma Motorcycle Club. We are happy to hear from you and ready to answer any questions or provide further information about our club. You can reach us through the following ways:</p>
            </div>
                ...
                <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div class="col d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p>
                                Akuma Motorcycle Club Headquarters <br>
                                1234 Tokyo Main Street <br>
                                Tokyo, 100-0001 <br>
                                Japan
                            </p>
                        </div>
                    ...
                    <div class="col d-flex align-items-start">
                        <div>
                            <h3 class="fs-2 text-body-emphasis">Phone Numbers</h3>
                            <p>
                                Head Office: +81-3-1234-5678 <br>
                                Customer Service: +81-3-8765-4321
                            </p>
                        </div>
                    </div>
                    <div class="col d-flex align-items-start">
                        <div>
                            <h3 class="fs-2 text-body-emphasis">Fax</h3>
                            <p>+81-3-2345-6789</p>
                        </div>
                    </div>
                    <div class="col d-flex align-items-start">
                        <div>
                            ...
                            <p>
                                General Information: info@akumamc.jp <br>
                                Customer Service: support@akumamc.jp <br>
                                Membership: membership@akumamc.jp
                            </p>
                        </div>
                    </div>
                    <div class="col d-flex align-items-start">
                        <div>
                            ...
                            <p>
                                Facebook: facebook.com/akumamc<br>
                                Instagram: instagram.com/akumamc <br>
                                Twitter: twitter.com/akumamc
                            </p>
                        </div>
                    </div>
                    <div class="col d-flex align-items-start">
