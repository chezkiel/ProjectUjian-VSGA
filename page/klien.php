    ...
    <div class="content">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a href="galerifoto.php" class="nav-link text-white" aria-current="page">
        ...
        <div class="container" mt-2>
            <h1 style="margin-left: 20px;">Tabel Klien</h1>
                ...
                <tbody class="table-group-divider">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                            <td><img src='" . $row["logo"] . "' class='card-img-top' alt='gambar' style='width: 100px; height: 100px;'></td>
                            <td>" . $row["name"] . "</td>
