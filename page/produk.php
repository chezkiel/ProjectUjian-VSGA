    ...
    <header class="py-3 navigation text-bg-dark">
        <div class="container d-flex flex-wrap justify-content-center">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="produk.php" class="nav-link link-body-emphasis px-2 active" aria-current="page">Produk Kami</a></li>
        ...
        <div class="my-5">
            <div class="p-5 text-center bg-body-tertiary">
                <div class="container py-5">
                    <h1 class="text-body-emphasis">What we Sell</h1>
                </div>
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4">Akuma Motor Club provides a select range of products and services specifically designed to cater to the needs of motorcycle enthusiasts. Our offerings focus on enhancing the riding experience while fostering a strong community spirit among our members.</p>
                </div>
                ...
                <?php
                    ...
                    if ($result->num_rows>0){
                        while($row = $result->fetch_assoc()) {
                            echo '<div class="col">';
                            echo '<div class="card">';
                            echo '<img src="' . $row["imgsource"] . '" class="card-img-top" alt="gambar" style="width: 100%; height: 400px;">';
                            echo '<div class="card-body">';
                            echo '<h5 class="card-title">' . $row["product_name"] . '</h5>';
                            echo '<p class="card-text">' . $row["description"] . '</p>';
                            echo '</div>';
                            echo '<div class="card-footer">';
                            echo '<small class="text-body-secondary">Price: ¥' . number_format($row["price"], 2) . 'yen</small>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                    }}
